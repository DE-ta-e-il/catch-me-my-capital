...
with DAG(
    ...
    wait_for_bronze = ExternalTaskSensor(
        ...
        external_dag_id="brz_msci_index_daily",
        external_task_id="fetch_msci_index_data",  # bronze DAG의 마지막 task
        timeout=600,  # 10분
    ...
    msci_glue_job = GlueJobOperator(
        task_id="msci_glue_job",
        job_name="team3_slv_msci_index_daily",  # Glue Job의 이름
        script_location="s3://team3-1-s3/glue_job_scripts/msci_glue_job.py",  # Glue Job의 스크립트가 위치한 S3 경로
