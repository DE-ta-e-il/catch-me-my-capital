...
with DAG(
    ...
    exchange_glue_job = GlueJobOperator(
        task_id="exchange_glue_job",
        job_name="team3_slv_exchange_daily",  # Glue Job의 이름
        script_location="s3://team3-1-s3/glue_job_scripts/exchange_rate_glue_job.py",  # Glue Job의 스크립트가 위치한 S3 경로
    ...
    # 태스크 순서 설정
    wait_for_bronze >> exchange_glue_job
